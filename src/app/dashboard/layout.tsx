...
const layout = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="grid h-dvh w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]  ">
      <div className="hidden border-r border-white border-opacity-40 bg-muted/40 md:block w-[280px] ">
      ...
      <div className="flex flex-col">
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="flex flex-col">
              <nav className="grid gap-2 text-lg font-medium">
                ...
                >
                  <Package2 className="h-6 w-6" />
                  <span className="sr-only">Thooku Biriyani</span>
                </Link>
                <Link
                  href="#"
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6 fixed right-0 left-[280px] top-[60px] h-[calc(100vh-60px)] overflow-y-auto custom ">
          {children}
        </main>
      </div>
    </div>
